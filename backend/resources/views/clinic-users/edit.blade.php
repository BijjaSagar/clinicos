        ...
        <form action="{{ route('clinic.users.update', $user) }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                @enderror
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Consultation Fee (₹)
                            <span class="text-xs text-gray-400 font-normal">(doctors only)</span>
                        </label>
                        <input type="number" name="consultation_fee" min="0" step="50"
                               value="{{ old('consultation_fee', $user->consultation_fee ?? 0) }}"
                               placeholder="e.g. 500"
                        ...
                        <p class="text-xs text-gray-400 mt-1">Auto-invoice uses this fee on visit finalisation.</p>
                    </div>
